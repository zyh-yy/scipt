...
def main():
    ...
    try:
            ...
            for script_id in inserted_ids:
                ...
                if script:
                    ...
                    if 'created_by' in column_names:
                        ...
                        cursor.execute('''
                        INSERT INTO script_versions
                        (script_id, version, content, created_at)
                        VALUES (?, ?, ?, ?)
                        ''', (
                            script_id,
                            "1.0.0",
        ...
        print("注: 如果看到关于脚本版本的警告，可以忽略，脚本数据已成功插入")
        return 0
